...
TxProposal.prototype._buildTx = function() {
  ...
  if (self.coin == 'btc') {
    ...
    Core = require('bitcore-lib-cash').Transaction;
  } else if (self.coin == 'safe') {
    Core = require('bitcore-lib-safecoin').Transaction;
    ...
    Core = require('bitcore-lib-zel').Transaction;
...
TxProposal.prototype._addSignaturesToBitcoreTx = function(tx, signatures, xpub) {
  ...
  if (self.coin == 'btc') {
      ...
      bHD = require('bitcore-lib-zel').HDPublicKey;
  } else if (self.coin == 'rvn') {
