...
// debugger;
  if (opts.coin && opts.coin == 'btc') {
    ...
    try {
      pubKey = new require('bitcore-lib-safecoin').PublicKey.fromString(opts.pubKey);
    } catch (ex) {
    ...
    try {
      pubKey = new require('bitcore-lib-zel').PublicKey.fromString(opts.pubKey);
    } catch (ex) {
...
WalletService.prototype.joinWallet = function(opts, cb) {
  ...
  if (opts.coin && opts.coin == 'btc') {
    ...
    try {
      xPubKey = require('bitcore-lib-safecoin').HDPublicKey(opts.xPubKey);
    } catch (ex) {
      return cb(new ClientError(invalk));
    }
  } else if (opts.coin && opts.coin == 'btcz') {
    ...
    try {
      xPubKey = require('bitcore-lib-zel').HDPublicKey(opts.xPubKey);
    } catch (ex) {
      return cb(new ClientError(invalk));
    }
  } else if (opts.coin && opts.coin == 'rvn') {
...
WalletService.prototype._getUtxos = function(coin, addresses, cb) {
  ...
  if (coin == 'btc') {
    ...
    BA = require('bitcore-lib-zel').Address;
  } else if (coin == 'rvn') {
        ...
        if (typeof coin === 'undefined' && input.address) {
          try {
            ...
            try {
              ...
              try {
                new require('bitcore-lib-safecoin').Address(input.address);
                var coin = 'safe';
              } catch (e) {
                try {
...
WalletService.prototype._validateOutputs = function(opts, wallet, cb) {
  ...
  if (coin == 'btc') {
    ...
    A = require('bitcore-lib-safecoin').Address;
    TD = require('bitcore-lib-safecoin').Transaction.DUST_AMOUNT
  } else if (coin == 'btcz') {
    ...
    A = require('bitcore-lib-zel').Address;
    TD = require('bitcore-lib-zel').Transaction.DUST_AMOUNT
  } else if (coin == 'rvn') {
